...
function getUrl(url) {
    ...
    // return `https://swapi.co${url}`
      return `https://cors-anywhere.herokuapp.com/https://thez5.com:8443${url}`
    // return `https://thez5.com:8443${url}`

    // return `${url}${separator}t=${timestamp}`;
}

/**
 * Base functionality fcomor the server request communications (GET, POST, ...).
